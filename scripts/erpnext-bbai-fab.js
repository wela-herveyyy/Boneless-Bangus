/**
 * DEPRECATED for Livro desks that already ship wela_generics_v15 BBAI bubble.
 * If you paste this, it only mounts when #bbai-chat-root is missing, and NEVER
 * uses window.open — iframe bubble only.
 */
(function () {
  ...
  function ensure() {
    ...
    root.innerHTML =
      ...
      '<div style="display:flex;justify-content:space-between;align-items:center;padding:14px 16px;background:#1972f5;color:#fff"><strong>BBAI</strong>' +
      ...
      '<iframe id="bbai-chat-frame" title="BBAI" style="flex:1;width:100%;border:0" sandbox="allow-scripts allow-same-origin allow-forms"></iframe></div>' +
