...
export function McpToolsPreviewModal({ server, onClose, onToggle }: McpToolsPreviewModalProps) {
  ...
  return (
    <Portal>
      <div className="fixed inset-0 z-140 flex items-center justify-center bg-on-surface/40 p-4 backdrop-blur-sm animate-fade-in">
        <div className="flex max-h-[88vh] w-full max-w-xl flex-col rounded-3xl border border-outline/20 bg-surface-container-lowest p-6 shadow-bloom">
          {/* Modal Header */}
