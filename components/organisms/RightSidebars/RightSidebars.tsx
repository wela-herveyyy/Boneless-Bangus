 ...
 */
const AUTH_SIDEBARS: ComponentType<{ topOffset?: string }>[] = [
...
const PUBLIC_THEME_PATHS = ["/landing", "/docs", "/sign-in", "/sign-up"];
...
export function RightSidebars() {
  ...
  const sidebars = showAuthRail ? AUTH_SIDEBARS : PUBLIC_SIDEBARS;
